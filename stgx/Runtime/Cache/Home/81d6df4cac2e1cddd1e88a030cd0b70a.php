...
<div class="container">
    <div class="row fixed-top">
        <div class="col-md-offset-1 col-md-2 ">
            <a class="btn btn-violet btn-block btn-lg" href="index.php?s=Home/Index/promotion">优惠活动</a>
        </div>
    </div>
    <br>
        ...
        <div class="col-md-offset-1 col-md-10">
            <div class="panel">
                <div class="panel-head">
                    <div class="col-md-12">
                        <h3 class="text-yellow">发布优惠活动</h3>
                    </div>
                </div>
                <div class="panel-content">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="text-white" >活动标题</label>
                            <input type="text" class="form-control"  placeholder="输入标题" id="title">
                        </div>
                        <div class="form-group">
                            <label class="text-white">活动描述</label>
                            <textarea class="form-control" rows="3" placeholder="添加活动描述" id="content"></textarea>
                        </div>
                        <div class="form-group">
                            <label class="text-white">活动地点</label>
                            <input type="text" class="form-control" placeholder="活动地点" id="place">
                        </div>
                        <div class="form-group">
                            <label class="text-white">活动时间</label>
                        ...
                        <div class="form-group">
                            <div class="row col-md-12">
                                <div class="row col-md-4">
                                    <div class="form-group">
                                        <br>
                                        <label class="text-white" >商店类型</label>
                                    ...
                                    <br>
                                    <button type="button" class="btn btn-lg btn-yellow btn-block" id="addPromotion">发布</button>
                                    <br>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript" src="Public/js/promotionPublish.js" ></script>
</body>
</html>