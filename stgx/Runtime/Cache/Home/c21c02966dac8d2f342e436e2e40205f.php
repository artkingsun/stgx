...
<div class="container">
        ...
        <div class="col-md-8">
            <div class="input-group input-group-lg">
                ...
                <!--<button class="btn btn-default" type="button">搜索</button>-->
                    <button class="btn btn-violet" id="searchFound">查找失物</button>
                </span>
            </div>
        </div>
        <div class="col-md-2">
            <div class="input-group-lg">
                <a href="index.php?s=Home/Index/foundPublish" class="btn btn-block btn-lg btn-violet">我要发布</a>
            </div>
    ...
    <div class="row" >
        <div class="col-md-offset-2 col-md-8">
            <ul class="nav-list-left" id="foundType">
    ...
    <div class="row">
        <div class="col-md-offset-2 col-md-8" id="foundList">
            <div class="panel">
                ...
                <div class="panel-content">
                    ...
                    <div class="panel-content-right">
                        ...
                        <strong class="text-yellow">发现地点：西南科技大学东1201</strong><br>
                        <strong class="text-yellow">发现时间：2015-08-13</strong><br>
                        <strong class="text-yellow">联系方式：QQ123456789</strong>
                    </div>
                </div>
                <div class="panel-footer">
                    <a href="#" class="btn btn-default btn-lg changeStatus">已领取</a>
                    <span class="id-none">foundid</span>
                    <button class="btn btn-danger btn-lg delFound">删除</button>
                </div>
            </div>
            ...
            <div class="panel">
                ...
                <div class="panel-footer">
                    <a href="#" class="btn btn-default btn-lg">已领取</a>
                    <span class="id-none">foundid</span>
...
<script type="text/javascript" src="Public/js/found.js" ></script>
</body>
</html>