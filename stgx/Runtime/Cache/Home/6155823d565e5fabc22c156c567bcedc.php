...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-2 nav-header-feedback">
            <a class="btn btn-lg btn-block btn-violet" href="index.php?s=Home/Index/feedback">我要反馈</a>
        </div>
    </div>
    <hr />
    <div class="row">
        <div class="col-md-6 col-md-offset-3" id="feedList">
            <!--<div class="panel">-->
                <!--<div class="panel-head">-->
                    <!--<span class="id-none">feedid</span>-->
                    <!--<button type="button" class="close delFeed" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
                    <!--<p class="text-white">2015-06-13 00:00:00</p>-->
                <!--</div>-->
...
<script type="text/javascript" src="Public/js/myFeedback.js" ></script>
</body>
</html>