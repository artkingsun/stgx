...
<div class="container">
    <div class="row">
        <div class="col-md-offset-4 col-md-4">
            <div class="row">
                <img class="img-rounded img-login" src="Public/images/icon.png">
            </div>
            <div class="row">
                <h1 class="nav-top-text big-text text-center">享你所想   用我所有</h1>
                <br>
            </div>
            <div class="row">
                ...
                <br>
                <button class="btn btn-violet btn-block" id="login">立即登录</button>
                <a href="index.php?s=Home/Index/register" class="btn btn-violet btn-block">注册账号</a>
            </div>
